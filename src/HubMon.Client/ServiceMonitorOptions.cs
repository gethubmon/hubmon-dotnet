...
public class ServiceMonitorOptions
{
    ...
    /// <summary>
    /// Enable collection of process metrics (CPU, Memory, Disk)
    /// </summary>
    public bool EnableMetrics { get; set; } = false;

    /// <summary>
    /// Enable HTTP request tracking (requests/min, active connections).
    /// Requires calling app.UseHubMonTracking() in the middleware pipeline.
    /// </summary>
